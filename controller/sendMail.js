            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
              ...
              <tr>
                <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                  <p style="margin: 0;">
                    Masalah masuk?<br>Mengatur ulang kata sandi Anda itu mudah.<br><br>Cukup tekan tombol di bawah dan ikuti petunjuknya. Kami akan membuat Anda bangun dan berjalan dalam waktu singkat.</p>
                </td>
              </tr>
              ...
              <tr>
                <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-bottom: 3px solid #d4dadf">
                  <p style="margin: 0;">إحسان,<br> ${domain}</p>
                </td>
              </tr>
          ...
          <td align="center" bgcolor="#e9ecef">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
              <tr>
                <td align="center" valign="top" style="padding: 36px 24px;">
                  <a href="https://${domain}" target="_blank" style="display: inline-block;">
                  <img src="https://telegra.ph/file/6c7b4972eb69c6aa3216a.jpg" alt="Logo" border="0" width="100" style="display: block; width: 100px; max-width: 100px; min-width: 100px;">
                  </a>
                </td>
              </tr>
            </table>
        ...
        <tr>
          <td align="center" bgcolor="#e9ecef">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
              ...
              <tr>
                <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                  <p style="margin: 0;">Terima kasih telah menggunakan rest api kami, Silakan tekan tombol di bawah untuk memverifikasi akun Anda.</p>
                </td>
              </tr>
