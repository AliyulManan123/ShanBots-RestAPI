...
creator = '乂 إحسان乂' // Nama 
port = 8080 //port host
LimitApikey = 999999 // Limit Apikey default
...
domain = 'shanbots-restapi.alifgendang.repl.co'// domain website tanpa http or https
...
loghandler = {
    error: {
        status: false,
        code: 503,
        message: '[!] Layanan Tidak Tersedia Atau Kesalahan',
        maintanied_by: `${creator}`
    },
    noturl: {
    	status: false,
    	code: 403,
    	message: '[!] Terlarang atau Error, url tidak valid',
    	maintanied_by: `${creator}`
    },
    notfound: {
    	status: false,
    ...
    notid: {
    	status: false,
    	code: 404,
    	message: '[!] Terlarang atau Error, Id atau Zona Tidak Valid',
    	maintanied_by: `${creator}`
    },
    redy: {
    	status: false,
    	code: 403,
    	message: '[!] Terlarang atau Error, Alias ​​​​sudah digunakan',
    	maintanied_by: `${creator}`
    },
    emoji: {
	    status: false,
	    code: 403,
	    message: '[!] Terlarang atau Error, Emoji tidak Ditemukan',
	    maintanied_by: `${creator}`
   },
    register: {
	    status: false,
